...
<body style="background-color:#df7611; background-image:url(images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
	...
	<%
		...
		String path="/w/regeste?type=sysadm&sysadmid="+username+"&sysadmpwd="+pwd;
	%>
	...
	<div class="regeste">
		<form action=<%=path %> method="post">
			<ul>
				<li>
					<span id="key">系统管理员编号</span>
					<input id="value" name="sysadmno" type="text" placeholder="001"></input>
				</li>
				<li>
					<span id="key">姓名</span>
					<input id="value" name="sysadmname" type="text" placeholder="root"></input>
				<li>
					<span id="key">性别</span>
					<input id="value" name="sysadmsex" type="text" placeholder="0"></input>
				</li>
				<li>
					<span id="key">电话</span>
					<input id="value" name="sysadmtel" type="text" placeholder="1234567890"></input>
				</li>
...
<span style="color: blue;"><i><%=username+":::"+pwd %></i></span>
		</form>
	</div>
