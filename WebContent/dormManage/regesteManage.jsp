...
<body style="background-color:#df7611; background-image:url(images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
	...
	<%
		...
		String path="/w/regeste?type=buildadm&buildadmid="+username+"&buildadmpwd="+pwd;
	%>
	...
	<form action=<%=path %> method="post">
		<ul>
			<li>
				<span id="key">宿舍管理员编号</span>
				<input id="value" name="buildadmno" type="text" placeholder="001"></input>
			</li>
			<li>
				<span id="key">姓名</span>
				<input id="value" name="buildadmname" type="text" placeholder="李刚"></input>
			</li>
			<li>
			...
			<li>
				<span id="key">性别</span>
				<input id="value" name="buildadmsex" type="text" placeholder="0"></input>
			</li>
			<li>
				<span id="key">电话</span>
				<input id="value" name="buildadmtel" type="text" placeholder="1234567890"></input>
			</li>
			...
			<input id="input" type="submit" value="注册" onmouseover="this.style.cursor='pointer'"/><br />
